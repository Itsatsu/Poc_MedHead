/**
 * Liste de reference des specialites NHS.
 * Doit rester synchronisee avec `backend/src/main/java/com/medhead/poc/domain/model/NhsSpecialty.java`
 * (source : "Donnees de reference sur les specialites NHS.pdf").
 */
export const NHS_SPECIALTIES: readonly string[] = [
